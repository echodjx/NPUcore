...
#[doc = "Field `txwm` reader - Transmit watermark pending"]
...
#[doc = "Field `rxwm` reader - Receive watermark pending"]
...
impl R {
    #[doc = "Bit 0 - Transmit watermark pending"]
    #[inline(always)]
    pub fn txwm(&self) -> TXWM_R {
        TXWM_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Receive watermark pending"]
    #[inline(always)]
