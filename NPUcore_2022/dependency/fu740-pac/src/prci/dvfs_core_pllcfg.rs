#[doc = "Register `dvfs_core_pllcfg` reader"]
pub struct R(crate::R<DVFS_CORE_PLLCFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DVFS_CORE_PLLCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DVFS_CORE_PLLCFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DVFS_CORE_PLLCFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `dvfs_core_pllcfg` writer"]
pub struct W(crate::W<DVFS_CORE_PLLCFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DVFS_CORE_PLLCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DVFS_CORE_PLLCFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DVFS_CORE_PLLCFG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PLL Configuration and Status register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dvfs_core_pllcfg](index.html) module"]
pub struct DVFS_CORE_PLLCFG_SPEC;
impl crate::RegisterSpec for DVFS_CORE_PLLCFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dvfs_core_pllcfg::R](R) reader structure"]
impl crate::Readable for DVFS_CORE_PLLCFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dvfs_core_pllcfg::W](W) writer structure"]
impl crate::Writable for DVFS_CORE_PLLCFG_SPEC {
    type Writer = W;
}
