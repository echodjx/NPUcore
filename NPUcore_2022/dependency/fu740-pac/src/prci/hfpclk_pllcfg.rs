#[doc = "Register `hfpclk_pllcfg` reader"]
pub struct R(crate::R<HFPCLK_PLLCFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFPCLK_PLLCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFPCLK_PLLCFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFPCLK_PLLCFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `hfpclk_pllcfg` writer"]
pub struct W(crate::W<HFPCLK_PLLCFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HFPCLK_PLLCFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HFPCLK_PLLCFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HFPCLK_PLLCFG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PLL Configuration and Status register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfpclk_pllcfg](index.html) module"]
pub struct HFPCLK_PLLCFG_SPEC;
impl crate::RegisterSpec for HFPCLK_PLLCFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfpclk_pllcfg::R](R) reader structure"]
impl crate::Readable for HFPCLK_PLLCFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hfpclk_pllcfg::W](W) writer structure"]
impl crate::Writable for HFPCLK_PLLCFG_SPEC {
    type Writer = W;
}
