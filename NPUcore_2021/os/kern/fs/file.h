...
void sfd_array_open(struct file *file);
void fd_array_close(struct file *file);
void sfd_array_close(struct file *file);
void fd_array_dup(struct file *to, struct file *from);
bool file_testfd(int fd, bool readable, bool writable);

int file_open(char *path, uint32_t open_flags);
int sfile_open(char *path, uint32_t open_flags);
int file_close(int fd);
int sfile_close(int fd);
int file_read(int fd, void *base, size_t len, size_t *copied_store);
int sfile_read(int fd, void *base, size_t len, size_t *copied_store);
int file_write(int fd, void *base, size_t len, size_t *copied_store);
int file_seek(int fd, off_t pos, int whence);
int sfile_seek(int fd, off_t pos, int whence);
